...
export default function Home({ params }) {
    ...
    return (
        <>
            <header className="fixed flex justify-between items-center h-[20%] w-[90%] pl-6 text-white">
                <Link href="/">
            ...
            <main>
                ...
                <article className="absolute bottom-0 h-[67.5vh] w-full bg-white rounded-lg p-10 flex flex-col gap-6">
